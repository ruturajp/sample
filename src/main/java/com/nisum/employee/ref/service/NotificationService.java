...
public class NotificationService implements INotificationService{
	...
	private static final String SRC_INTERVIEWER_VM = "./src/interviewer.vm";
	...
	private static final String SRC_CANDIDATE_VM = "./src/candidate.vm";
	...
	private static final String SRC_FEEDBACK_HR_VM = "./src/feedback_hr.vm";
	...
	public String sendScheduleMail(InterviewSchedule interviewSchedule, String mobileNo, String altMobileNo, String skypeId) throws Exception{
		...
		Template candidateTemplate = velocityEngine.getTemplate(SRC_CANDIDATE_VM);
		...
		Template interviewerTemplate = velocityEngine2.getTemplate(SRC_INTERVIEWER_VM);
	...
	public void sendFeedbackMail(InterviewFeedback interviewFeedback)
		...
		Template candidateTemplate = velocityEngine
				.getTemplate(SRC_FEEDBACK_HR_VM);
